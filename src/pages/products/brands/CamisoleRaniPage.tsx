      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-2xl font-display font-semibold text-deepa-teal mb-4">Premium RANI Camisoles</h2>
            <p className="text-gray-300 mb-6">
              Experience luxury and comfort with our RANI camisole collection.
            </p>
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-center">
                <Button asChild className="bg-deepa-teal hover:bg-deepa-dark-teal text-black flex items-center gap-2 w-full md:w-auto">
                  <a href="#" download="RANI_Camisole_Catalog.pdf">
                    <Download size={18} />
