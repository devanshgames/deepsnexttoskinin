...
import FeelsLingerieProductCard from '@/components/brands/FeelsLingerieProductCard';

const FeelsLingeriePage = () => {
  // Sample product data for Feels Lingerie
  const products = [
    {
      id: 501,
      name: "FEELS Premium Bra",
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="rounded-lg overflow-hidden">
            <img alt="FEELS LINGERIE Collection" src="/lovable-uploads/FEELSCOVER.png" className="w-full h-[400px] object-contain" />
          </div>
            ...
            <ul className="space-y-4 text-gray-300">
               <li className="flex items-center">
                <Button asChild className="bg-deepa-teal hover:bg-deepa-dark-teal text-black flex items-center gap-2 w-full md:w-auto">
                  <a href="/lovable-uploads/feels.pdf" download="FEELS.pdf">
                    <Download size={18} />
