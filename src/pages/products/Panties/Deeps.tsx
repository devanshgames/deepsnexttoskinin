      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="rounded-lg overflow-hidden">
            <img src="/lovable-uploads/FRONT.jpg" alt="DEEP'S Panties Collection" className="w-full h-[400px] object-contain" />
          </div>
          <div className="flex flex-col justify-center">
            <h2 className="text-2xl font-display font-semibold text-deepa-teal mb-4">Premium DEEP'S Panties</h2>
            <p className="text-gray-300 mb-6">
              We're excited to announce our premium DEEP'S Panties collection featuring comfortable designs and quality materials.
            </p>
