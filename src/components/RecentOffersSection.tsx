...
const RecentOffersSection = () => {
  ...
  return <section className={`py-12 bg-black transition-all duration-1000 transform ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
      <div className="container mx-auto px-4">
        ...
        <Carousel className="w-full max-w-5xl mx-auto">
          <CarouselContent>
            {offers.map((offer, idx) => <CarouselItem key={offer.id} className="md:basis-1/2 lg:basis-1/3">
                <div className={`p-2 animate-fade-in`} style={{
              ...
              animationFillMode: "backwards"
                  ...
                  <Card className="bg-black border border-deepa-teal/30 overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <CardContent className="p-4">
                      ...
                      <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="block mt-4 w-full bg-deepa-teal text-black py-2 rounded font-semibold hover:bg-deepa-dark-teal transition-colors text-center animate-fade-in" style={{
