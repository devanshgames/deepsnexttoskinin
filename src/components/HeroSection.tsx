      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 animate-fade-in">
            <h1 className="text-4xl md:text-5xl font-display font-bold text-deepa-dark-purple mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-deepa-purple hover:bg-deepa-dark-purple text-white px-8 py-6 text-lg">
                Browse Products
              </Button>
              <Button variant="outline" className="border-deepa-purple text-deepa-purple hover:bg-deepa-purple hover:text-white px-8 py-6 text-lg">
                Contact Us
              </Button>
            </div>
          </div>
