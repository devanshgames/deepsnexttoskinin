...
const WhyChooseUsSection = () => {
  ...
  return <section id="why-us" className="py-16 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map(reason => <Card key={reason.id} className="hover:shadow-lg transition-shadow border-l-4 border-l-deepa-teal bg-[#111]">
